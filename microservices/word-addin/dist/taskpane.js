...
.ck-action.sev-medium { border-left-color: var(--amber); }
...
/* ── Mode tabs ── */
.ck-tabs { display: flex; gap: 4px; padding: 6px var(--pane-pad) 0; background: var(--surface); border-bottom: 1px solid var(--border); flex-shrink: 0; }
.ck-tab { flex: 1; font-size: 12.5px; font-weight: 600; color: var(--text-secondary); background: none; border: none; padding: 9px 0 10px; cursor: pointer; border-bottom: 2px solid transparent; font-family: var(--font-body); }
.ck-tab:hover { color: var(--text-primary); }
.ck-tab.on { color: var(--navy); border-bottom-color: var(--amber); }
...
.sim-placeholder { display: flex; flex-direction: column; align-items: center; text-align: center; gap: 12px; color: var(--text-secondary); font-size: 12.5px; line-height: 1.55; padding: 30px 22px; }
...
function Simulator({ side, setSide, terms, headings, loading, error, run, ranSide, }) {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "ck-sim", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-setup", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { className: "sim-title", children: "Negotiation Simulator" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { className: "sim-sub", children: "Pick your side and war-game the lease \u2014 fallback positions for every off-market term, plus how the other side fights back." })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-side", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "sim-side-label", children: "I represent the" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-toggle", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { className: `sim-seg${side === "tenant" ? " on" : ""}`, onClick: () => setSide("tenant"), disabled: loading, children: "Tenant" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { className: `sim-seg${side === "landlord" ? " on" : ""}`, onClick: () => setSide("landlord"), disabled: loading, children: "Landlord" })] })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { className: "ck-btn primary sim-run", onClick: run, disabled: loading, children: loading ? "War-gaming the lease…" : terms ? "Re-run war-game" : "War-game the lease" })] }), loading && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-loading", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "t-bubble", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("i", {}), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("i", {}), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("i", {})] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", { children: ["War-gaming the lease as the ", side, "\u2026"] })] })), error && !loading && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "ck-error-bubble sim-error", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { children: error }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { className: "ck-retry", onClick: run, children: "Retry" })] })), !loading && !error && terms && terms.length === 0 && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", { className: "sim-empty", children: ["No off-market terms surfaced for the ", ranSide, ". Try the other side."] })), !loading && terms && terms.length > 0 && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-brief", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", { className: "sim-count", children: [terms.length, " term", terms.length > 1 ? "s" : "", " to negotiate as the ", ranSide] }), terms.map((term, i) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_TermCard__WEBPACK_IMPORTED_MODULE_1__["default"], { term: term, heading: headings[term.clauseRef], side: ranSide ?? side }, i)))] })), !loading && !error && !terms && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "sim-placeholder", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "sim-ph-mark", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { children: "\u2694" }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { children: "Run the war-game to see your fallback ladders and the counterparty's likely pushback." })] }))] }));
}
